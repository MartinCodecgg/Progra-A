     ...
     while not eof(archE) do
           begin
                ...
                while (car <> ' ') and not eof(archE) do
                      ...
                      if contCaract <> 0 then    //Casi siempre hay que poner un if con alguna condicion a la salida del 2do while. En este caso porque
                      contContrasenias:=contContrasenias + 1;          //pueden tocar varios blancos seguidos y sumar al contador no tiene sentido
