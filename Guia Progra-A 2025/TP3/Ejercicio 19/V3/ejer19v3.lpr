...
begin
     ...
     readln;
end.                                                   //fn + top, back, left, right       ir a comienzo/final de archivo o linea
                                                       //ctrl + left + right               Para desplazarme entre palabras y no por letras
                                                       //ctrl + shift + left o right para ir seleccionando a grupos
                                                       //shitt + fn + left o right para seleccionar toda o mitad de la linea
