...
//Ignorar {procedure calcularTotalyDesc(var total:real;var totalDesc:byte;var condALLDesc:boolean);
...
//La lectura de un archivo no se debe leer por separado, se lee en un procedimiento o en el programa principal, sino hay que usar variables globales
var
   tipo:char;
