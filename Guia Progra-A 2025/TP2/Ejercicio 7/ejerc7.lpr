...
begin
     ...
     //El 7 es del descuento total
     //Si un ejercicio nos piden que apliquemos descuento sobre el precio total
     //Debemos crear una variable que acumule los descuentos y los aplique al final
end.
