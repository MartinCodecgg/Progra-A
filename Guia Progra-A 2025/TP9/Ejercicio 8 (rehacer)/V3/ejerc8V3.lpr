...
begin
     ...
     while not eof(archPrenda) or not eof(archPedido) do
                ...
                else if regPrenda.cod>regPedido.cod then
                   begin
                     write(archTemp,regPrenda);
                     read(archPrenda,regPrenda);
                   end
                    ...
                    begin
                         ...
                         else if regPrenda.talle>regPedido.talle then
                            begin
                                 write(archTemp,regPrenda);
                                 read(archPrenda,regPrenda);
                            end
                             ...
                             begin
                                  ...
                                  else if regPrenda.color>regPedido.color then //Nuevamente escribo y no hago nada
                                     begin
                                          write(archTemp,regPrenda);
                                          read(archPrenda,regPrenda);
                                     end
...
Function EsModificacion(regPrenda:TregPrenda; regPedido:TregPedido):boolean;
begin
     write('hola');
end;

Procedure Enfrenta2(var archPrenda:TarchPrenda; var archPedido:TarchPedido);  //Un enfrentamiento con solo modificacion y pasar, sin alta ni baja
var
   regPrenda:TregPrenda;
   regPedido:TregPedido;
   archTemp:TarchPrenda;
...
begin
     ...
     Enfrenta2(archPrenda,archPedido);
     readln;
end.
